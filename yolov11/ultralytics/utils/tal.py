...
class TaskAlignedAssigner(nn.Module):
    ...
    @torch.no_grad()
    def forward(self, pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes, gt_angles, gt_depths, mask_gt):
        """
        ...
        try:
            return self._forward(pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes, mask_gt, gt_angles, gt_depths)
    ...
    def _forward(self, pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes, mask_gt, gt_angles, gt_depths):
        """
        Compute the task-aligned assignment.
        ...
        # Assigned target
        target_labels, target_bboxes, target_scores, target_angles, target_depths = self.get_targets(gt_labels, gt_bboxes, target_gt_idx, gt_angles, gt_depths, fg_mask)
        ...
        return target_labels, target_bboxes, target_scores, target_angles, target_depths, fg_mask.bool(), target_gt_idx
    ...
    def get_targets(self, gt_labels, gt_bboxes, target_gt_idx, gt_angles, gt_depths, fg_mask):
        """
        ...
        target_angles = gt_angles.flatten()[target_gt_idx]  # (b, h*w)
        target_depths = gt_depths.flatten()[target_gt_idx]
        ...
        return target_labels, target_bboxes, target_scores, target_angles, target_depths
