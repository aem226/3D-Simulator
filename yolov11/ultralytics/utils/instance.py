...
class Instances:
    ...
    def __init__(self, bboxes, angles, depths, segments=None, keypoints=None, bbox_format="xywh", normalized=True) -> None:
        """
    ...
    def concatenate(cls, instances_list: List["Instances"], axis=0) -> "Instances":
        ...
        angles = instances_list[0].angles
        depths = instances_list[0].depths
        ...
        cat_angles = np.concatenate([b.angles for b in instances_list], axis=axis)
        cat_depths = np.concatenate([b.depths for b in instances_list], axis=axis)
        return cls(cat_boxes, cat_angles, cat_depths, cat_segments, cat_keypoints, bbox_format, normalized)
